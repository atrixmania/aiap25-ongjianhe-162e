...
class FeatureEngineer:
    ...
    def __init__(self, config=None):
        ...
        self.comment_cluster_centroids = None
        self.comment_cluster_samples = None
        self.comment_cluster_labels = None
    ...
    def fit(self, train_df):
        ...
        print("FeatureEngineering fitted")
    ...
    def transform(self, df):
        ...
        print("FeatureEngineering transform completed")
    ...
    def _business_rules(self, df):
        ...
        print("Pre-process - Business Rules by category")
        return df
    ...
    def _lead_time(self, df):
        ...
        print("Pre-process - Lead time & Service Level Computation")
        return df
    ...
    def _fit_clientdriver_behaviour(self, df):
        ...
        print("Feature Engineering - Client & Driver Statistics fitted")
    ...
    def _fit_bad_clientdriver(self, df):
        ...
        print("Feature Engineering - Bad Client Driver Statistics fitted")
    ...
    def _top_comment(self, df):
        ...
        rating_db = (
            ...
            .groupby(level=0)
            .apply(
                lambda x: x.index.get_level_values(1).tolist()
            )
            .to_dict()
        )
        ...
        df.attrs["top_comments_rating"] = rating_db
        df.attrs["top_comments_client"] = client_db

        print(
            "Pre-process - Step 5.5 Top Comments Memory Built"
        )
    ...
    def _fit_top20_comment(self, df):
        ...
        print(
            "Feature Engineering - Step 5.6 FIT Comment Clustering"
        )
        ...
        if top20_comments.empty:
            ...
            print(
                "Step 5.6 - No valid bad-review comments found"
            )
        ...
        print(
            f"Step 5.6 - "
            f"{len(self.comment_cluster_centroids)} clusters created"
        )
    ...
    def _apply_top20_comment(self, df):
        ...
        print(
            "Feature Engineering - Step 5.6 APPLY Comment Clustering"
        )
        ...
        # =====================================================
        # 3. UNIQUE NON-EMPTY COMMENTS ONLY
        # =====================================================
        ...
        unique_cluster_labels = [
            cluster_ids[index]
            for index in best_cluster_indices
        ]


        # =====================================================
        # 8. COMMENT -> CLUSTER LOOKUP
        # =====================================================

        comment_to_cluster = dict(
            zip(
                unique_comments,
                unique_cluster_labels
            )
        ...
        # =====================================================
        # 11. STORE EXPLODED VERSION FOR UI
        # =====================================================

        #df.attrs["df_exploded"] = (
        #    df.explode(
        #        "business_categories"
        #    )
        #)
